...
function Hero() {
  return (
    <div className="min-h-screen min-w-full bg-black-grey flex flex-col justify-center p-10">
...
{/*           <img
          ...
          <div className="px-20 py-6 z-30">
            ...
            <div className=" text-center mt-64">
              <div className="text-7xl font-bold  leading-none text-wheat-white">
                We elevate{" "}
                <svg
                  width="430"
                  height="69"
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop stop-opacity="0" />
                      <stop offset="0.236329" stop-color="#6633EE" />
                      <stop offset="1" stop-color="white" />
                    </linearGradient>
                  </defs>
                </svg>
              </div>
              <div className="mt-6 text-4xl font-light text-wheat-white antialiased">
                Propelling brilliance to new heights!
              </div>
              <div className="mt-6 text-xl font-light text-wheat-white antialiased mx-auto max-w-2xl">
              ...
              <button className="mt-6 mx-1 px-8 py-4 rounded-lg font-normal tracking-wide bg-btn-purple text-white outline-none">
                Get a Quote
                <svg
                  className="inline"
                  width="20"
              ...
              <button className="mt-6 mx-1 px-8 py-4 rounded-lg font-normal tracking-wide border text-white bg-btn-secondary border-wheat-white">
                Get in Touch
                <svg
                  className="inline"
                  width="20"
